...
class Classifier(Resource):
	def post(self, bot_id):
		"""
		Provides a REST Interface to retrieve the classification of an image for a pretrained model bedlonging to a bot.
		...
		Optionally the number of return_labels can be passed to the Request Body Form with the key 'image'
