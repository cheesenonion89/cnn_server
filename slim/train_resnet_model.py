...
def train():
    protobuf_dir = dirs.get_protobuf_dir('resnet')  # Read the protobuffer files for the initial car dataset
    ...
    bot_model_dir = dirs.get_model_data_dir('resnet')
