...
def _get_filenames_and_classes(training_data_dir):
  ...
  Args:
    training_data_dir: A directory containing a set of subdirectories representing
      class names. Each subdirectory should contain PNG or JPG encoded images.

  Returns:
    A list of image file paths, relative to `training_data_dir` and the list of
...
def _convert_dataset(split_name, filenames, class_names_to_ids, protobuf_dir):
  ...
  Args:
    ...
    class_names_to_ids: A dictionary from class names (strings) to ids
      (integers).
    protobuf_dir: The directory where the converted datasets are stored.
  """
